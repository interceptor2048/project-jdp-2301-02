package com.kodilla.ecommercee.entityTestSuites;
...
public class CartEntityTestSuite {
    ...
    void createCartAndSaveToDb() {
        //Given
        Product product1 = new Product(454L, "Product1", "description1", new BigDecimal(2345), new Group());
        Product product2 = new Product(455L, "Product2", "description2", new BigDecimal(837465),new Group());
        List<Product> products = new ArrayList<>();
        products.add(product1);
        products.add(product2);
        Cart cart = new Cart(1L, new User(), products);
